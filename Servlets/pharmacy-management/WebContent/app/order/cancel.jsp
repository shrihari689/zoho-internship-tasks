...
<t:wrapper title="Return a Order | Zoho Pharma">
	...
	<main class="p-5 mx-5">
		...
		<header>
			<h1 class="font-bold text-xl">Cancel an Order</h1>
			<p class="text-sm text-gray-600 font-light">You can only cancel an order within 04 hours from the order time</p>	
		</header>
		...
		<section class="my-5">
			...
			<div class="flex flex-col items-center justify-center py-5">
				<c:if test="${orders.size() == 0}">
					...
					<p class="text-gray-600">No orders are eligible for cancel!</p>
				</c:if>
									...
									<div class="w-full flex items-center justify-between">
					                 ...
					                 <div class="flex items-center justify-between">
				                		...
				                		<form action="/orders/cancel/${item.id}" method="POST">
					                		<t:button other="w-28 bg-red-600 hover:bg-red-700" type="submit" value="Cancel" /> 
				                		</form>
									</div>	
					            </div>
					        </li>

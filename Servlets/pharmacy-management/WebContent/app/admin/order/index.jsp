...
<t:wrapper title="Pending Orders | Zoho Pharma">
	...
	<section class="px-5">
		...
		<h2 class="font-bold text-lg my-2">Pending Orders</h2>
		...
		<div class="flex flex-col items-center justify-center py-5">
			<c:if test="${orders.size() == 0}">
				...
				<p class="text-gray-600">You don't have any pending orders</p>
			</c:if>
								...
								<div class="w-full flex items-center justify-between">
				                 ...
				                 <div class="flex items-center justify-between">
				                	...
				                	<div class="flex items-center space-x-2">				                	
					                	<form action="/app/admin/orders/complete/${item.id}" method="POST">
					                		<t:button other="w-28 bg-green-600 hover:bg-green-800" type="submit" value="Complete" /> 
					                	</form>
					                	<form action="/orders/cancel/${item.id}" method="POST">
					                		<t:button other="w-28 bg-red-600 hover:bg-red-800" type="submit" value="Cancel" /> 
					                	</form>
				                	</div>
								</div>	
				            </div>

...
<t:wrapper title="Completed Returns | Zoho Pharma">
	...
	<section class="px-5">
		...
		<nav class="flex space-x-8" aria-label="Tabs">
          <a href="/app/admin/returns/pending" class="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
            Pending
          </a>
		...
		<h2 class="font-bold text-lg my-2">Completed Returns</h2>
		...
		<div class="flex flex-col items-center justify-center py-5">
			<c:if test="${orders.size() == 0}">
				...
				<p class="text-gray-600">You don't have any completed returns</p>
			</c:if>
							...
							<div class="px-4 py-4 sm:px-6">
								<div class="w-full flex items-center justify-between">
				                 ...
				                 <div class="flex items-center justify-between">
				                	<p class="text-sm flex-1 text-gray-600 truncate">
				                		Quantity: <strong>${item.quantity}</strong>
				                	</p>
				                	<t:button-with-link other="bg-green-600 hover:bg-green-700 pointer-events-none cursor-default" link="" value="${item.status.toString()}" /> 
								</div>	
				            </div>
				        </li>

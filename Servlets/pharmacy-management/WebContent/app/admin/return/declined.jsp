...
<t:wrapper title="Declined Orders | Zoho Pharma">
	...
	<section class="px-5">
		...
		<h2 class="font-bold text-lg my-2">Declined Orders</h2>
		...
		<div class="flex flex-col items-center justify-center py-5">
			<c:if test="${orders.size() == 0}">
				...
				<p class="text-gray-600">You don't have any declined returns</p>
			</c:if>
